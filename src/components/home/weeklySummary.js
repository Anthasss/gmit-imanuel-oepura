...
export default function WeeklySummary() {
  return (
    <div className="flex flex-col md:flex-row bg-gray-300 rounded-3xl p-6 md:p-8 shadow-lg w-4/5 mx-auto gap-6 md:gap-12">
      {/* image */}
      ...
      <div className="flex flex-1 flex-col justify-center text-gray-800">
        <h2 className="text-4xl font-bold mb-2 tracking-wide font-sans">Weekly Summary</h2>
